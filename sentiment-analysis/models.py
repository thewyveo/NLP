...
def logreg(train_data, test_data): 
    ...
    test_sentences = [line for line in test_data['sentence']]  # split by tabs, strip whitespace, skip header line ([1:]).
    true_labels = [line for line in test_data['sentiment']]    # test sentences are the second col. and true labels the last.
